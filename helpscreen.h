...
private slots:
    void on_buttonHelpSettings_clicked();

    void on_buttonHelpSecurity_clicked();

    void on_buttonHelpEntertainment_clicked();

    void on_buttonHelpLighting_clicked();

    void on_buttonHelpClimate_clicked();
