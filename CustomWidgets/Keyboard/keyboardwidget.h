...
public:
    ...
    void setReceivingField (QWidget *object);
    void setCurrentString(const QString& string);
...
public slots:
    void onEnterButtonPressed (const QString& key);
    void onViewStatusChanged(QDeclarativeView::Status);

private:
    QDeclarativeView *declView;
    QWidget	*editField;
    QLayout	*keyboardLayout;
