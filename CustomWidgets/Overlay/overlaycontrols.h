...
#ifndef OVERLAYCONTROLS_H
#define OVERLAYCONTROLS_H
...
class OverlayControls : public QWidget
{
    Q_OBJECT
    
public:
    explicit OverlayControls(QWidget *parent = 0);
    ~OverlayControls();
...
signals:
    void climateRequest();
    void lightingRequest();
    void securityRequest();
    void mediaRequest();
    void homeRequest();
    
private:
    Ui::OverlayControls *ui;

private slots:
    void onViewStatusChanged(QDeclarativeView::Status status);
//    void onSecurityButtonPressed();
//    void onClimateButtonPressed();
//    void onMediaButtonPressed();
//    void onLightingButtonPressed();

};

#endif // OVERLAYCONTROLS_H
