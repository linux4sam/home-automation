...
#ifndef WEATHERXMLCONTENTHANDLER_H
#define WEATHERXMLCONTENTHANDLER_H
...
const QString SNOW_ICON_LOCATION = ":/resources/weather/weather-snow";
const QString SHOWERS_ICON_LOCATION = ":/resources/weather/weather-showers";
const QString STORM_ICON_LOCATION = ":/resources/weather/weather-storm";
const QString RAIN_ICON_LOCATION =  ":/resources/weather/weather-rain";
const QString CLOUDS_ICON_LOCATION = ":/resources/weather/weather-clouds";
const QString SUN_ICON_LOCATION = ":/resources/weather/weather-sun";

class WeatherXmlContentHandler : public QXmlDefaultHandler
{
  public:
    bool startDocument();
    ...
    /**
     * @brief params
     * @todo research if these should be public or private members
     */
    QString mode;
    QList<int> minimumTemps;
    QList<int> maximumTemps;
    int humidity;
    int precipitation;
    QList<QString> weatherIconLocations;
    QString weatherForecastDescription;
    QString stateShortName;
  ...
  private:
    bool isNight;
    void appendIconLocation(const QString & weatherDescription);
    void setParameter( QList<int>* param, const QString & ch, int maxParamSize );
    void setParameter( QList<double>* param, const QString & ch, int maxParamSize );
    void setParameter( int* param, const QString & ch );
    void setParameter( QString * param, const QString & ch );

};
#endif // WEATHERXMLCONTENTHANDLER_H
