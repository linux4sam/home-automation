...
class DayWeather : public QWidget
{
    Q_OBJECT
    
public:
    explicit DayWeather(QWidget *parent = 0);
    ~DayWeather();
    void setData(WeatherXmlContentHandler* handler);
    void setDay(QString day);
    void setTemperature(QString temp);
    void setCompactView( bool);

    static QSize sNormalIconSize;
    static QSize sLargeIconSize;

signals:
    void show5DayForecast();
