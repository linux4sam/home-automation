...
#ifndef DAYWEATHERDETAIL_H
#define DAYWEATHERDETAIL_H
...
namespace Ui {
class DayWeatherDetail;
}

class DayWeatherDetail : public QWidget
{
    Q_OBJECT
    
public:
    explicit DayWeatherDetail(QWidget *parent = 0);
    ~DayWeatherDetail();
    void setHandler(WeatherXmlContentHandler *xmlHandler);

public slots:
    void setWeatherDetailValues();

private:
    Ui::DayWeatherDetail *ui;
    WeatherXmlContentHandler *handler;
};

#endif // DAYWEATHERDETAIL_H
