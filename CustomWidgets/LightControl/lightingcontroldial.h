...
#ifndef LIGHTINGCONTROLDIAL_H
#define LIGHTINGCONTROLDIAL_H

#include <QAbstractSlider>

extern bool isSmallResolution;

class LightingControlDial : public QAbstractSlider
{
    Q_OBJECT
public:
    explicit LightingControlDial(QWidget *parent = 0);
    
public:
    int brightnessRange();
    bool onOff;

    //override the control and paint events
protected:
...
signals:
    void dimLightSignal();
    void increaseBrightnessSignal();
    void kickoffTimerSignal();
    
};

#endif // LIGHTINGCONTROLDIAL_H
