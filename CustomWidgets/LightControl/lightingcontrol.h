...
class LightingControl : public QWidget
{
    Q_OBJECT
    
public:
    explicit LightingControl(QWidget *parent = 0);
    ~LightingControl();
...
signals:
    bool switchOnOff(bool status);

protected:
    void setupDial();
    QString getBrightness(int brightness);
