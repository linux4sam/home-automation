...
**
** Summary: This class implements logic for the main three control buttons: Help, Settings, Home
**          which show up in the bottom right corner of most screens
**
****************************************************************************/
...
#include "ui_maincontrols.h"

/***
 ** Default constructor
 **/
MainControls::MainControls(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MainControls)
{
    ui->setupUi(this);
    ...
    if (isSmallResolution) {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-home-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-home-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonHome->setIcon(icon);
        ui->buttonHome->setIconSize(QSize(ui->buttonHome->iconSize().width() * wSFactor, ui->buttonHome->iconSize().height() * hSFactor));

        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-settings-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-settings-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonSettings->setIcon(icon);
        ui->buttonSettings->setIconSize(QSize(ui->buttonSettings->iconSize().width() * wSFactor, ui->buttonSettings->iconSize().height() * hSFactor));

        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-help-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/smallcontrol-buttons/button-help-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonHelp->setIcon(icon);
        ui->buttonHelp->setIconSize(QSize(ui->buttonHelp->iconSize().width() * wSFactor, ui->buttonHelp->iconSize().height() * hSFactor));

    } else {

        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-home-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-home-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonHome->setIcon(icon);

        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-settings-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-settings-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonSettings->setIcon(icon);

        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-help-off.png"), QSize(), QIcon::Normal, QIcon::Off);
        icon.addFile(QString::fromUtf8(":/resources/control-buttons/button-help-on.png"), QSize(), QIcon::Normal, QIcon::On);
        ui->buttonHelp->setIcon(icon);
    }
...
/***
 ** Function handler for the Home Button
 **/
void MainControls::on_buttonHome_clicked()
{
    buttonHome_set();
    emit(homeRequested());
}
 ...
 **/
void MainControls::on_buttonSettings_clicked()
{
    buttonSettings_set();
 ...
 **/
void MainControls::on_buttonHelp_clicked()
{
    buttonHelp_set();
    emit(helpRequested());
}
...
/***
 ** Set states of all buttons when Settings button is clicked
 ** Function ensures that only one of the buttons in the panel is in "pressed" state
 **/
void MainControls::buttonSettings_set()
{
    ui->buttonHelp->setChecked(false);
    ui->buttonHome->setChecked(false);
    ui->buttonSettings->setChecked(true);
}

/***
 ** Set states of all buttons when Help button is clicked
 ** Function ensures that only one of the buttons in the panel is in "pressed" state
 **/
void MainControls::buttonHelp_set()
{
    ui->buttonHelp->setChecked(true);
    ui->buttonSettings->setChecked(false);
    ui->buttonHome->setChecked(false);
}

/***
 ** Set states of all buttons when Home button is clicked
 ** Function ensures that only one of the buttons in the panel is in "pressed" state
 **/
void MainControls::buttonHome_set()
{
    ui->buttonHelp->setChecked(false);
...
/***
 ** Reset states of all buttons to "unpressed"
 **/
void MainControls::buttonSet_none()
{
    ui->buttonHelp->setChecked(false);
    ui->buttonHome->setChecked(false);
    ui->buttonSettings->setChecked(false);
...
void MainControls::toggle()
{
    QPropertyAnimation *buttonsAnim = new QPropertyAnimation(this, "geometry");

    // Determine Ui widget position, if pos.x if > height() * .5 widget is on top
    buttonsAnim->setDuration(transition_speed);
    buttonsAnim->setStartValue(this->geometry());

    //    QPushButton *button = findChild<QPushButton *>("buttonToggle");
    //    if (button->pos().y() > (this->height() * .5)) {
    //        buttonsAnim->setEndValue(QRect(0, ui->topMenuWidget->height(), ui->buttonWidget->width(), ui->buttonWidget->height()));
    //    } else {
    //        buttonsAnim->setEndValue(QRect(0, this->height() - 50, ui->buttonWidget->width(), ui->buttonWidget->height()));
    //    }
...
void MainControls::animFinished()
{
    QPushButton *button = findChild<QPushButton *>("buttonToggle");
    ...
    if (button) {
        ...
        if (button->pos().y() > this->height() * .5) {
            ...
            QIcon icon;
            icon.addFile(QString::fromUtf8(":/resources/smallcamera/up.png"), QSize(), QIcon::Normal, QIcon::Off);
            button->setIcon(icon);

        } else {

            QIcon icon;
                  icon.addFile(QString::fromUtf8(":/resources/smallcamera/down.png"), QSize(), QIcon::Normal, QIcon::Off);
            button->setIcon(icon);
        }
    }
}
