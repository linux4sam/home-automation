...
#include "Settings/climatesettings.h"
#include "Settings/prefssettings.h"
#include "Settings/lightingsettings.h"
...
public:
    ...
    ~SettingsScreen();
    PrefsSettings* getPrefsSettings() { return prefsSettings; }
    LightingSettings* getLightingSettings() { return lightingSettings; }
    ClimateSettings* getClimateSettings() { return climateSettings; }
    MediaSettings* getMediaSettings() { return mediaSettings; }
    SecuritySettings* getSecuritySettings() { return securitySettings; }

signals:
    void sendingHVACZonesInfo(QStringList &);
    void requestHVACLabels();
    
private slots:
    void on_buttonSettingsPrefs_clicked();

    void on_buttonSettingsMedia_clicked();

    void on_buttonSettingsLighting_clicked();

    void on_buttonSettingsClimate_clicked();

    void on_buttonSettingsSecurity_clicked();
...
public slots:
    void requestedHVACLabels();
    void sendingHVACZonesSlot(QStringList & list){ emit(sendingHVACZonesInfo(list));}
