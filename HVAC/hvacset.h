...
class HVACSet : public QWidget
{
    Q_OBJECT
    
public:
    explicit HVACSet(QWidget *parent = 0);
    ~HVACSet();
    void setZoneLabels(QStringList&);
    void setHandler(WeatherXmlContentHandler* newHandler);
...
private slots:
    ...
    void on_fanButtonAuto_clicked();
    void on_fanButtonOff_clicked();

    void onZoneSelectorVisible( bool);
    void onZoneSelected( QString zone);
    void onHVACSystemChanged(int);
