...
const QString LOCAL_RADAR_GIF = ":/resources/weather/resources/nxrd_pa_.gif";

namespace Ui {
class RadarInfo;
}

class RadarInfo : public QWidget
{
    Q_OBJECT
    
public:
    explicit RadarInfo(QWidget *parent = 0);
    ~RadarInfo();
