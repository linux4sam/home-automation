...
#include <QWidget>
#include "CustomWidgets/Weather/weatherxmlcontenthandler.h"
...
class WeatherDetail : public QWidget
{
    Q_OBJECT
    
public:

    explicit WeatherDetail(QWidget *parent = 0);
    ~WeatherDetail();
    DayWeatherDetail* getWeatherDetailWidget();
    void setWeather(WeatherXmlContentHandler* handler);
