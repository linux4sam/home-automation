...
**
** Summary: Qt UI handling class for the Weather detail screen. Please consult weatherdetail.ui file for
**          object definitions
**
****************************************************************************/
 ...
 ** Default constructor
 **/
WeatherDetail::WeatherDetail(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::WeatherDetail)
{
    ui->setupUi(this);
...
/***
 ** Method that returns a pointer to a single day detail widget
 **/
DayWeatherDetail* WeatherDetail::getWeatherDetailWidget()
{
    return ui->widgetWeatherDetail;
}
