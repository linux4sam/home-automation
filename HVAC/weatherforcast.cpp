...
**
** Summary: Qt UI handling class for the Weather Forcast screen. Please consult weatherforcast.ui file for
**          object definitions
**
****************************************************************************/
...
/***
 ** Handler for the Left button - switch current screen to previous
 **/
void WeatherForcast::on_pushButtonLeft_clicked()
{
    emit(requestHVAC());
}
 ...
 **/
void WeatherForcast::on_pushButtonRight_clicked()
{
    emit(requestWeatherDetails());
}

/***
 ** Return a pointer outside this object to the WeatherWidget
 **/
WeatherWidget* WeatherForcast::getWeatherWidget()
{
    return ui->widgetWeatherForcast;
}
