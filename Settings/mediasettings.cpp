...
**
** Summary: Qt UI handling class for the Media settings. Please consult mediasettings.ui file for
**          object definitions
**
****************************************************************************/
...
/***
 ** Default constructor
 ** Preset the default values for QEditLine
 **/
MediaSettings::MediaSettings(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::MediaSettings)
{
    ui->setupUi(this);

    mediaRoomsList << "Dining Room";
    mediaRoomsList << "Living Room";
    mediaRoomsList << "Patio";

    ui->lineEdit_Room1->setText(mediaRoomsList.at(0));
    ui->lineEdit_Room2->setText(mediaRoomsList.at(1));
    ui->lineEdit_Room3->setText(mediaRoomsList.at(2));
...
/***
 ** Save updated data in a local structure
 **/
void MediaSettings::updateMediaRooms()
{
    while(mediaRoomsList.count()>1)
        mediaRoomsList.clear();

    mediaRoomsList.append(ui->lineEdit_Room1->text());
    mediaRoomsList.append(ui->lineEdit_Room2->text());
    mediaRoomsList.append(ui->lineEdit_Room3->text());
}

/***
 ** Handler for the save button
 **/
void MediaSettings::on_pushButtonSave_clicked()
{
    updateMediaRooms();
    emit(mediaRoomsChanged(mediaRoomsList));
}
