...
class MediaSettings : public QWidget
{
    Q_OBJECT
    
public:
    explicit MediaSettings(QWidget *parent = 0);
    ~MediaSettings();
    void updateMediaRooms();
    
signals:
    void mediaRoomsChanged(QStringList & list);
