...
#ifndef CLIMATESETTINGS_H
#define CLIMATESETTINGS_H
...
class ClimateSettings : public QWidget
{
    Q_OBJECT
    
public:
    explicit ClimateSettings(QWidget *parent = 0);
    ~ClimateSettings();
    
signals:
    void sendingZonesInfo(QStringList &);

public:
    QStringList& getZones();
    QStringList climateZonesList;

private slots:
    void on_pushSaveButton_clicked();

private:
    Ui::ClimateSettings *ui;
};

#endif // CLIMATESETTINGS_H
