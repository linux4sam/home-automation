...
public:
    explicit LightingSettings(QWidget *parent = 0);
    ~LightingSettings();
    void setZones(QStringList &zonesList);
    void updateData();
    void updateLightingRoomNames();

signals:
    void roomNamesChanged(QList<QStringList> &my2DArray);
    
private slots:
    void on_selectZone_currentIndexChanged(int index);

    void on_pushButtonSave_clicked();

private:
    Ui::LightingSettings *ui;

    QList<QStringList> localSettings;
};
