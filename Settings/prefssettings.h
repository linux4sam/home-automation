...
#ifndef PREFSSETTINGS_H
#define PREFSSETTINGS_H

#include <QWidget>

const int DEFAULT_ZIPCODE = 15222;
...
class PrefsSettings : public QWidget
{
    Q_OBJECT
    
public:
    explicit PrefsSettings(QWidget *parent = 0);
    ~PrefsSettings();
    static int getZipCode();

signals:
    void zipCodeChanged(int arg1);
    void temperatureChanged(int idx);

private slots:
    void on_zipCode_textChanged(const QString &arg1);

    void on_pushButtonSave_clicked();

    void on_temperature_currentIndexChanged(int index);
