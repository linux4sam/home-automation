...
#ifndef ATMELMEDIAPLAYER_H
#define ATMELMEDIAPLAYER_H
...
namespace Ui {
class AtmelMediaPlayer;
}

extern bool isSmallResolution;


class AtmelMediaPlayer : public QWidget
{
    Q_OBJECT

public:
    explicit AtmelMediaPlayer(QWidget *parent = 0);
    ~AtmelMediaPlayer();
    ...
    void setFileToPlay(const QString &path);
    void stopPlayback();

public slots:
    void trackTime();
    void totalTime();
    void newVideoToPlay(bool);
...
private:
    Ui::AtmelMediaPlayer *ui;
};

#endif // ATMELMEDIAPLAYER_H
