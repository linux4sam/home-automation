...
**
** Summary: Dynamic zone selection at a smaller resolution screen
**
****************************************************************************/
...
class ZoneSelector : public QWidget
{
    Q_OBJECT
public:
    explicit ZoneSelector( QWidget *parent);
    ~ZoneSelector();
    void setZoneList( const QStringList& zoneList);
    void setCanHide(bool canHide);
    void setBackgroundColor(QColor color);
    void setLineColor( QColor color);
    void setTitlePixmap(const QPixmap& pixmap);
    void setButtonFont( const QFont& font);
    void setWidth( int width);

signals:
    void zoneSelected( QString );
    void menuShown( bool );
...
private slots:
    void buttonClicked();
    void setButtonsVisibility(bool);
    void postAnimation();
    void hideTimeout();
...
private:
    ...
    void addButtonToLayout(QString text, QLayout* layout);

    QStringList mZoneList;
    QColor mBackgroundColor;
    ImageWidget *mTitleImage;
    QFont mFont;
    bool mCheckFirstButton;
    QWidget *mBottomLine;
    QHBoxLayout *mButtonLayout;
    QVBoxLayout *mMainLayout;
    bool mCanHide;
    QPropertyAnimation *mShowAnimation, *mHideAnimation;
