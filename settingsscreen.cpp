...
**
** Summary: Qt UI handling class for the Settings screen. Please consult settingsscreen.ui file for
**          object definitions
**
****************************************************************************/
...
/***
 ** Default constructor
 ** Create objects for managing settings of the following features:
 ** - climate
 ** - lights
 ** - security
 ** - media
    ...
    ui(new Ui::SettingsScreen)
{
    ...
    if (isSmallResolution) {
        ...
        ui->label->setPixmap(QPixmap(QString::fromUtf8(":/resources/smalltopnav-all/title-settings.png")));
        ui->label_2->setPixmap(QPixmap(QString::fromUtf8(":/resources/smalltopnav-all/nav-filler.png")));

        ui->buttonSettingsClimate->setMinimumSize(ui->buttonSettingsClimate->minimumWidth() * wSFactor, ui->buttonSettingsClimate->minimumHeight() * hSFactor);
        QFont f = ui->buttonSettingsClimate->font();
        f.setPointSize(f.pointSize() * hSFactor);
        ui->buttonSettingsClimate->setFont(f);

        ui->buttonSettingsLighting->setMinimumSize(ui->buttonSettingsLighting->minimumWidth() * wSFactor, ui->buttonSettingsLighting->minimumHeight() * hSFactor);
        f = ui->buttonSettingsLighting->font();
        f.setPointSize(f.pointSize() * hSFactor);
        ui->buttonSettingsLighting->setFont(f);

        ui->buttonSettingsMedia->setMinimumSize(ui->buttonSettingsMedia->minimumWidth() * wSFactor, ui->buttonSettingsMedia->minimumHeight() * hSFactor);
        f = ui->buttonSettingsMedia->font();
        f.setPointSize(f.pointSize() * hSFactor);
        ui->buttonSettingsMedia->setFont(f);

        ui->buttonSettingsSecurity->setMinimumSize(ui->buttonSettingsSecurity->minimumWidth() * wSFactor, ui->buttonSettingsSecurity->minimumHeight() * hSFactor);
        f = ui->buttonSettingsSecurity->font();
        f.setPointSize(f.pointSize() * hSFactor);
        ui->buttonSettingsSecurity->setFont(f);

        ui->buttonSettingsPrefs->setMinimumSize(ui->buttonSettingsPrefs->minimumWidth() * wSFactor, ui->buttonSettingsPrefs->minimumHeight() * hSFactor);
        f = ui->buttonSettingsPrefs->font();
        f.setPointSize(f.pointSize() * hSFactor);
        ui->buttonSettingsPrefs->setFont(f);

        ui->label_2->setMaximumSize(ui->label_2->maximumWidth() * wSFactor, ui->label_2->maximumHeight() * hSFactor);
        ui->label_2->setPixmap(QPixmap(QString::fromUtf8(":/resources/smalltopnav-all/nav-filler.png")));

        ui->verticalLayout_3->setContentsMargins(ui->verticalLayout_3->contentsMargins().left() * wSFactor,
                                                 ui->verticalLayout_3->contentsMargins().right() * wSFactor,
                                                 ui->verticalLayout_3->contentsMargins().bottom() * hSFactor,
                                                 ui->verticalLayout_3->contentsMargins().top() * hSFactor);
        ...
        ui->topMenuLayout->setContentsMargins(0, 0, 8, 0);
        ...
        ui->topMenuWidget->move(-ui->topMenuWidget->width() + 35, 0);
        ...
        QObject::connect(ui->buttonSettingsClimate, SIGNAL(clicked()), this, SLOT(runTimer()));
        QObject::connect(ui->buttonSettingsLighting, SIGNAL(clicked()), this, SLOT(runTimer()));
        QObject::connect(ui->buttonSettingsMedia, SIGNAL(clicked()), this, SLOT(runTimer()));
        QObject::connect(ui->buttonSettingsPrefs, SIGNAL(clicked()), this, SLOT(runTimer()));
        QObject::connect(ui->buttonSettingsSecurity, SIGNAL(clicked()), this, SLOT(runTimer()));

    } else {
        ui->label->setPixmap(QPixmap(QString::fromUtf8(":/resources/topnav-all/title-settings.png")));
...
void SettingsScreen::clearButtonSelections()
{
    ui->buttonSettingsClimate->setChecked(false);
    ui->buttonSettingsLighting->setChecked(false);
    ui->buttonSettingsMedia->setChecked(false);
    ui->buttonSettingsPrefs->setChecked(false);
    ui->buttonSettingsSecurity->setChecked(false);
}

void SettingsScreen::on_buttonSettingsPrefs_clicked()
{
    clearButtonSelections();
    ui->buttonSettingsPrefs->setChecked(true);
    lightingSettings->setVisible(false);
...
{
    clearButtonSelections();
    ui->buttonSettingsMedia->setChecked(true);
    prefsSettings->setVisible(false);
    lightingSettings->setVisible(false);
    climateSettings->setVisible(false);
    securitySettings->setVisible(false);
...
{
    clearButtonSelections();
    populateLightingZones();
    ui->buttonSettingsLighting->setChecked(true);
    prefsSettings->setVisible(false);
    climateSettings->setVisible(false);
...
{
    clearButtonSelections();
    ui->buttonSettingsSecurity->setChecked(true);
    prefsSettings->setVisible(false);
    lightingSettings->setVisible(false);
    climateSettings->setVisible(false);
...
/***
 ** Set lighting zones if they are changed
 **/
void SettingsScreen::populateLightingZones()
{

    lightingSettings->setZones(climateSettings->getZones());
}

/***
 ** Populate Zones for HVAC ComboBox
 **/
void SettingsScreen::requestedHVACLabels()
{
    climateSettings->getZones();
}
 ...
 **/
void SettingsScreen::toggleMenus()
{
    ...
    if (ui->topMenuWidget->pos().x() >= 0) {
        topMenuAnim->setEndValue(QRect(-ui->topMenuWidget->width() + 35, 0, ui->topMenuWidget->width(), ui->topMenuWidget->height()));
...
void SettingsScreen::animFinished()
{
    ...
    if (ui->topMenuWidget->pos().x() >= 0) {
        ...
        ui->verticalLayout_4->setContentsMargins(0, 30, 0, 0);
