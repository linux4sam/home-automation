...
class HVACScreen : public QWidget
{
    Q_OBJECT
    
public:
    explicit HVACScreen(QWidget *parent = 0);
    ~HVACScreen();
    WeatherForcast* getWeatherForcast(){ return weatherForecastWidget; }
    HVACSet* getHVACSet() { return hvacControl; }
    
signals:
    void requestLabelsforHVAC();
...
public:
    WeatherForcast* weatherForecastWidget;
};
