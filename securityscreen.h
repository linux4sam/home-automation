...
#ifndef SECURITYSCREEN_H
#define SECURITYSCREEN_H
...
class SecurityScreen : public QWidget
{
    Q_OBJECT
    
public:
    explicit SecurityScreen(QWidget *parent = 0);
    ~SecurityScreen();
    void turnOffCameras();
    
private slots:
    void on_buttonZone1_clicked();

    void on_buttonZone2_clicked();

    void on_buttonZone3_clicked();

    void setSecurityZoneNames(QStringList & zoneList);
...
private:
    Ui::SecurityScreen *ui;

    int timeOut;

    QTimer *autoHideTimer;

    void setButtonState(bool isChecked);
    bool getButtonState();
};

#endif // SECURITYSCREEN_H
